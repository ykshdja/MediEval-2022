...
var connectionUserCount = new signalR.HubConnectionBuilder()
    //.configureLogging(signalR.LogLevel.Information)- Use Trace for More debugging
...
function newWindowLoadedOnClient() {
    connectionUserCount.invoke("NewWindowLoaded", "Yash khanduja").then((value) => console.log(value));
}
